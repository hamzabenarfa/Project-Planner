...
function TaskCard({ task }: Props) {
  ...
  if (isDragging) {
    return (
      <div
        ...
        style={style}
        className="
          opacity-30 bg-mainBackgroundColor p-2.5 h-[100px] min-h-[300px] items-center 
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`p-2.5 h-[100px] min-h-[300px] flex flex-col items-start gap-4 text-left 
            rounded-3xl hover:ring-2 hover:ring-inset
          hover:ring-blue-300 cursor-grab relative bg-gradient-to-r from-cyan-200 to-blue-300`}

    >
      {/* send id to tasknav then darwer to do delete or update  */}
        <TaskNav />
